-- Update the trigger function to detect and notify on level ups
...
BEGIN
  ...
  IF new_level > old_level THEN
    INSERT INTO public.notifications (
      ...
      'Level Up! 🎉',
      CASE new_level
        WHEN 2 THEN 'Congratulations! You''ve reached Level 2 (Silver)! Your platform fee is now reduced to 10%.'
        WHEN 3 THEN 'Amazing! You''ve reached Level 3 (Gold)! Your platform fee is now just 5%!'
      ...
      jsonb_build_object(
        ...
        'new_platform_cut', CASE new_level WHEN 3 THEN 5 WHEN 2 THEN 10 ELSE 15 END
      )
    );
  END IF;
