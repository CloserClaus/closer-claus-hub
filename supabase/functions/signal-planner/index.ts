...
const ACTOR_CATALOG: ActorEntry[] = [
  // ── Hiring Intent ──
  {
    ...
    description: "Scrapes LinkedIn job postings via public pages. Best for hiring intent — find companies actively hiring for specific roles like SDRs, sales reps, marketers, etc. Supports splitSearchByLocation to bypass LinkedIn's 1000-result cap.",
    inputSchema: {
      ...
      maxItems:              { type: "number",  default: 2500, description: "Max job listings to scrape. Set high (2000+) because downstream filtering is aggressive and discards 80-95% of raw results." },
      ...
      splitSearchByLocation: { type: "boolean", default: true, description: "Split search by location to bypass LinkedIn's 1000-result cap" },
