...
const DemoWalkthrough = () => {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      link.click();
    } catch (error) {console.error('Failed to download image:', error);} finally
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-6">
        <div className="max-w-2xl w-full text-center space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-lg text-muted-foreground max-w-lg mx-auto">Walk through how Closer Claus handles everything from hiring SDRs to paying commissions — end to end.
