  ...
  const stages = [
    ...
    { 
      ...
      leads: [
        ...
        { name: 'Michael Torres', company: 'CloudScale Inc', value: '$12,000', assignee: 'SM', hasCalendar: true },
      ]
    },
    { 
      name: 'Proposal', 
                      ...
                      {stage.leads.map((lead, leadIndex) => (
                        <Card 
                          ...
                          className={`cursor-pointer hover:shadow-md transition-shadow ${
                            lead.hasCalendar ? 'ring-2 ring-purple-500/50 bg-purple-500/5' : ''
                          }`}
                        >
                          <CardContent className="p-4">
                            ...
                            {lead.hasCalendar && (
                              <div className="p-2 bg-purple-500/10 rounded-lg mb-3 border border-purple-500/20">
                                <div className="flex items-center gap-2 text-sm">
                                  <Calendar className="h-4 w-4 text-purple-500" />
                                  <span className="font-medium">Thu, Feb 6 • 2:00 PM</span>
                                </div>
